...
class Todo extends Component {
  ...
  componentDidMount() {
    const json = localStorage.getItem('filterTodo');
  ...
  saveTask = (enteredTask) => {
    ...
    this.handleShow(this.state.filterTodo);
  ...
  handleShow = (array) => {
    ...
    const json = JSON.stringify(this.state.filterTodo)
    localStorage.setItem('filterTodo' ,json)
  }
  ...
  filterHandler = (status) => {
    ...
    switch (status) {
      ...
      case 'active':
        ...
        break;
      case 'all':
        this.setState({ filterTodo: [...this.state.filterTodo, this.state.arrayOfTask] });
        break;
      default:
